  ...
  _render() {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        .actions { display:flex; align-items:center; gap:14px; margin-top:18px; } button { background:var(--primary-color); border:0; border-radius:8px; color:var(--text-primary-color, white); cursor:pointer; font:inherit; font-weight:700; padding:11px 17px; } button:disabled { cursor:wait; opacity:.65; } .read-only { color:var(--secondary-text-color); font-size:13px; }
